 ...
 */
    (context: Context?, earthquakes: List<Earthquake?>?) :
    ...
    override fun getView(
        ...
        val magnitudeView =
            listItemView!!.findViewById<View>(R.id.magnitude) as TextView
        ...
        val originalLocation: String = currentEarthquake.location
        ...
        if (originalLocation.contains(LOCATION_SEPARATOR)) {
            ...
            val parts =
                originalLocation.split(LOCATION_SEPARATOR)
                    .toTypedArray()
        ...
        val primaryLocationView =
            listItemView.findViewById<View>(R.id.primary_location) as TextView
        // Display the location of the current earthquake in that TextView
        primaryLocationView.text = primaryLocation

        // Find the TextView with view ID location offset
        val locationOffsetView =
            listItemView.findViewById<View>(R.id.location_offset) as TextView
